# MyCms# MyCms
---
# MyCms - 現代化全端營運管理系統 (Enterprise Management Platform)
...
本專案採用 **MIT License**。
---
把這段文字貼上 GitHub 後，記得截 3 張清楚的圖放上去（截圖要漂亮，甚至可以加點陰影特效）。

當你完成這一步，你的「戰服」就穿好了。**要不要我幫你寫一封投遞履歷時用的「自我推薦信（Cover Letter）」？** 這能幫你在眾多應徵者中直接吸引主管的目光！
