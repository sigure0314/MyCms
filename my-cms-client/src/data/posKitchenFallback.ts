import type { PosKitchenMenuItem, PosKitchenOrder } from '../types/posKitchen';

export const posKitchenFallbackMenu: PosKitchenMenuItem[] = [
  {
    id: 'classic-burger',
    name: 'Classic Burger',
...
export const posKitchenFallbackOrders: PosKitchenOrder[] = [
  {
    id: 'offline-order-1',
